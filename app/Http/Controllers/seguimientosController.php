...
class seguimientosController extends Controller
{
    ...
    public function diasHabiles ($Fecha, $Dias){
        $proximoSeguimiento = new DateTime($Fecha);
        $proximoSeguimiento -> modify("+$Dias days");
        $diasSemana = [0, 6];
        while (in_array($proximoSeguimiento->format("w"), $diasSemana))
        {
            $proximoSeguimiento->modify("+1 day");
        }
        return $proximoSeguimiento -> format("d/m/Y");
    }
